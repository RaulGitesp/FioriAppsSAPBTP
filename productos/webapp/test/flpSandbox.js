		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#namespproductos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespproductos-display": {
								"semanticObject": "namespproductos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namesp.productos",
									"url": sap.ui.require.toUrl("namesp/productos")
								}
							}
						}
					}
