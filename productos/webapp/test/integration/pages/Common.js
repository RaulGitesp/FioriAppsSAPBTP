sap.ui.define([
	...
	return Opa5.extend("namesp.productos.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["namesp/productos/localService/mockserver"], function (mockserver) {
